...
|--------------------------------------------------------------------------
|
| Here is where you can reject training requests and notify the users via . 
|
|
*/
...
|--------------------------------------------------------------------------
|
| Here is where you can set the training requests' status as Done and notify the users via sending email. 
|
|
*/
